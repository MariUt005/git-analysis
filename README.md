...
Для удаления репозитория необходимо выбрать его в списке, кликнув по нему ПКМ. Выбранная строка станет синей. 
...
Для анализа репозитория необходимо выбрать его
